...
<!-- Mirrored from paul-themes.com/html/covid-19/search-nothing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 May 2021 12:16:11 GMT -->
<head>
...
<section class="search_found_area">
<div class="overlay_bg"></div>
<div class="section_vertical_align">
<div class="container">
<div class="search_found_text text-center">
<i class="linearicons-sad icon"></i>
<h2>Nothing found</h2>
<p>Nothing found
Nothing matched your search criteria. Please try again with different keywords
or go back to <a href="index.html">Homepage</a></p>
<form action="#" class="search-form input-group">
<input type="text" name="search" class="form-control" placeholder="Search">
<span class="input-group-addon"><button type="submit"><i class="linearicons-magnifier"></i></button></span>
</form>
</div>
