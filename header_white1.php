...
<li class="checker_btn" style="margin-left: -20px;">
	...
	<a id="english_btn" href="symptom-checker" ><!-- <i class="linearicons-pulse"></i> --> ইংরেজি</a>
...
<li class="checker_btn" style="margin-left: -40px;margin-top:0px">
	...
	<a id="english_btn1" href="symptom-checker"  style="background: #01cfbe !important;padding: 5px;border-radius: 4px;color: white;font-size: 12px;"><!-- <i class="linearicons-pulse"></i> --> ইংরেজি</a>
