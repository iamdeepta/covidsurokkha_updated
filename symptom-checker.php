...
<meta property="og:url" content="https://covidsurokkha.com/symptom-checker" />
...
<meta property="twitter:url" content="https://covidsurokkha.com/symptom-checker" />
...
<link rel="canonical" href="https://covidsurokkha.com/symptom-checker" />
...
<div class="body_wrapper" id="body_wrapper" style="background-color: #f5f5f9">
	...
	<span style="height:200px;margin-top:-200px;display:block;visibility:hidden"><p>আধুনিক <a href="https://covidsurokkha.com/">কোভিড সুরক্ষার</a> লক্ষণ পরীক্ষক দিয়ে করোনাভাইরাসের লক্ষণগুলি পরীক্ষা করে করোনা সন্দেহ দূর করুন। এখনই আপনার করোনা উপসর্গগুলি প্রবেশ করান।</p></span>
...
$(".check_now_button").mouseout(function(){
  		...
  		$("#call_now").html('কল করুন<i class="linearicons-phone"></i>');
...
function none_of_the_above1_checked(){
	...
	function confirm(){
		...
		//googleTranslator();
			...
			$('#hi_name').html('হ্যালো '+full_name+',');
			$('#hi_text').html('চিন্তা করবেন না! আমাদের মূল্যায়ন অনুসারে, ভাইরাস সংক্রমণের আপনার ঝুঁকি কম। তবে, বাংলাদেশে করোনা কেসের উত্থানের প্রেক্ষিতে আপনার নীচের প্রদত্ত গাইডলাইনগুলি অনুসরণ করা উচিত।');

			$("#check_btn").css("display","none");

			$("#our_advice").css("display","block");
			$("#our_advice_header").html("আমাদের পরামর্শ নীচের মত:");
			$("#our_advice_text1").html("* গৃহে থাকুন");
			$("#our_advice_text2").html("* আপনার হাত এবং বাহু পরিষ্কার করে কমপক্ষে ত্রিশ সেকেন্ডের জন্য সাবান এবং জল দিয়ে ঘন ঘন আপনার হাত ধুয়ে নিন");
			$("#our_advice_text3").html("* লক্ষণগুলি পর্যবেক্ষণ করুন; যদি সেগুলি বৃদ্ধি পায় বা অন্য কোনও লক্ষণ দেখা দেয় তবে কোনও চিকিত্সক প্র্যাকটিশনারের সাথে দেখা করুন যিনি আপনাকে পরীক্ষা প্রয়োজন কিনা সে বিষয়ে পরামর্শ দেবেন");
			$("#our_advice_text4").html("* পুষ্টিকর খাবার খান, টেনশন মুক্ত থাকুন এবং সক্রিয় থাকার জন্য বাড়িতে হালকা অনুশীলন করুন!");
		...
		function displayAdviceForMedium(){
			...
			$('#hi_name').html('হ্যালো '+full_name+',');
			$('#hi_text').html('আমাদের মূল্যায়ন অনুসারে, দয়া করে বাড়িতে স্ব-পৃথকীকরণ চালিয়ে যান, আপনার লক্ষণগুলি নিরীক্ষণ করুন এবং নীচে প্রদত্ত নির্দেশিকাগুলি অনুসরণ করুন।');
			...
			$("#our_advice_header").html("আমাদের পরামর্শ নীচের মত:");
			$("#our_advice_text1").html("* গৃহে থাকুন");
			$("#our_advice_text2").html("* নিজেকে পৃথক করা।");
			$("#our_advice_text3").html("* বাড়ির কাছের লোকদের সুরক্ষার জন্য মুখোশের মতো প্রতিরক্ষামূলক গিয়ার পরুন।");
			$("#our_advice_text4").html("* আপনার হাত এবং বাহু পরিষ্কার করে কমপক্ষে ত্রিশ সেকেন্ডের জন্য সাবান এবং জল দিয়ে ঘন ঘন আপনার হাত ধুয়ে নিন।");
			$("#our_advice_text5").html("* টিস্যু নিষ্পত্তি যা ব্যবহৃত হয়।");
			$("#our_advice_text6").html("* লক্ষণগুলি পর্যবেক্ষণ করুন। যদি অন্য কোনও লক্ষণ দেখা দেয় তবে কোনও মেডিকেল প্র্যাকটিশনারের সাথে দেখা করুন যিনি আপনাকে পরীক্ষা প্রয়োজন কিনা সে বিষয়ে পরামর্শ দেবেন।");
			$("#our_advice_text7").html("* আপনার পরিবারের সদস্যদের বাদে লোকের সংস্পর্শে আসবেন না। যদি তারা কোনও কারণে বাইরে যান তবে বাড়িতে কোনও কিছু স্পর্শ করার আগে তারা হাত ধোওয়ার বিষয়টি নিশ্চিত করুন।");
		...
		function displayAdviceForHigh(){
			...
			$('#hi_name').html('হ্যালো '+full_name+',');
			$('#hi_text').html('আমাদের মূল্যায়ন অনুসারে, কর্তব্যরত দায়িত্বে থাকা মেডিকেল চিকিৎসকদের সাথে কথা বলাই ভাল। অতিরিক্তভাবে, আপনাকে এবং অন্যদের সুরক্ষিত রাখতে দয়া করে নীচের নির্দেশিকাগুলি অনুসরণ করুন।');

			$("#check_btn").css("display","none");

			$("#our_advice").css("display","block");
			$("#our_advice_header").html("আমাদের পরামর্শ নীচের মত:");
			$("#our_advice_text1").html("* আপনাকে চিকিত্সা-ডাক্তারদের পরামর্শের ভিত্তিতে কোভিড -১৯ এর জন্য একটি পরীক্ষা করতে হতে পারে।");
			$("#our_advice_text2").html("* আপনি পরীক্ষা কেন্দ্রের তালিকা পেতে পারেন।");
			$("#our_advice_text3").html("* গৃহে থাকুন।");
			$("#our_advice_text4").html("* নিজেকে পৃথক করা।");
			$("#our_advice_text5").html("* বাড়ির কাছের লোকদের সুরক্ষার জন্য মুখোশের মতো প্রতিরক্ষামূলক গিয়ার পরুন।");
			$("#our_advice_text6").html("* আপনার হাত এবং বাহু পরিষ্কার করে কমপক্ষে ত্রিশ সেকেন্ডের জন্য সাবান এবং জল দিয়ে ঘন ঘন আপনার হাত ধুয়ে নিন।");
			$("#our_advice_text7").html("* টিস্যু নিষ্পত্তি যা ব্যবহৃত হয়।");
