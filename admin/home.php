...
include("db.inc.php");
...

    {
      ...
      $daily_death_date_query = mysqli_query($dbc, "SELECT * from tbl_daily_death_date") or die(mysqli_error($dbc));
      $dddq=mysqli_fetch_array($daily_death_date_query);
...
<div class="container col-md-8">
  ...
  <div class="card" style="margin-top: 2%">
    ...
    <div class="card-body">
      ...
      <div class="row">
        <p>Date(En): <?=$dddq['daily_death_date_en']?></p>
        <p style="margin-left: 20px">Date(Bn): <?=$dddq['daily_death_date_bn']?></p>
      </div>
