<?php
    ...
    if(isset($_POST['amb_id'])){
        if(is_numeric($_POST['amb_id'])){
            $query = mysqli_query($dbc, "UPDATE tbl_ambulance SET ambulance_remove_status = 1 where ambulance_id = '".$_POST['amb_id']."'");
