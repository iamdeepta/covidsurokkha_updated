...
<li class="checker_btn" style="margin-left: -40px;">
		...
		<a id="bengali_btn" href="../symptom-checker.php"><!-- <i class="linearicons-pulse"></i> --> BENGALI</a>
...
<li class="checker_btn" style="margin-left: -40px;;margin-top:0px">
		...
		<a id="bengali_btn" href="../symptom-checker.php" style="background: #01cfbe !important;padding: 5px;border-radius: 4px;color: white;font-size: 12px;"><!-- <i class="linearicons-pulse"></i> --> BENGALI</a>
