...
<div class="col-lg-6">
  ...
  <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Full Name" onkeyup="saveValue(this)" autocomplete="off">
</div>

</div>
<div class="col-lg-6">
  <div class="form-group">
  <input type="text" class="form-control" id="mobile_number" name="mobile_number" placeholder="Mobile Number (optional)" onkeyup="saveValue(this)" autocomplete="off">
  </div>
