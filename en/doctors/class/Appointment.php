...
class Appointment
{
	public $base_url = 'http://localhost/covidtracking/covid/doctors/';
	//public $base_url = 'https://covidsheba.com/doctors/';
	public $connect;
	public $query;
	public $statement;
	public $now;
	...
	/*public function __construct()
	{
		$this->connect = new PDO("mysql:host=localhost;dbname=covizwvz_doctor_appointment", "covizwvz_covidsheba", "covidsheb@");
