...
<html lang="en">
	...
	<body>
		<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
			<div class="col">
		    	<h5 class="my-0 mr-md-auto font-weight-normal"><img id="covidshebalogos" src="../assets/images/covidshebalogo.png" alt="covidsheba" style="width: 220px;height: 50px"></h5>
		    </div>
		    <?php
