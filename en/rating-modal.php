...
if (isset($_POST['rating_review'])) {
	...
	$output .= '<div class="blur_bg_rating" id="blur_bg_rating" style="position: fixed;z-index: 999;bottom: 0px;top: 0px;width: 100vw;height: 100vh;background-color: rgb(0.5,0.5,0.5,0.5);display: none;"></div>
	...
	<div style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
		...
		<p class="thank_you_review" style="text-align: center;margin-top:26px;color:white">Thank you for your feedback and time.</p>
		</div>
	</div>
	</div>
...
<div class="card rating_modal_card" style="position: fixed;z-index: 999999999999999999;top: 27%;left: 35%;border-radius: 15px;box-shadow: 0px 0px 10px 0px rgb(0.2,0.2,0.2,0.2);background-color:#58547e;border:none">
	<div class="card-body">
		...
		<div class="form-group input_elements" style="display: flex;flex-direction: column;justify-content: flex-start;margin-top: 20px;width: 30vw">
			<p style="text-align: center;color:white">Rate Us</p>
			<input type="text" name="name" class="name form-control" id="name" placeholder="Your Name" style="border-radius: 15px" onfocusin="hide_name_placeholder()" onfocusout="show_name_placeholder()" autocomplete="off">
			<span class="name_error" style="color: rgb(243, 120, 120);float: left;font-size: 13px;display: none;">Please enter your name</span>
			<textarea type="text" name="feedback" class="feedback form-control" id="feedback" placeholder="Your Feedback (optional)" style="margin-top: 15px;border-radius: 15px" rows="5" onfocusin="hide_feedback_placeholder()" onfocusout="show_feedback_placeholder()" autocomplete="off"></textarea>
			<span class="feedback_error" style="color: rgb(243, 120, 120);float: left;font-size: 13px;display: none;">Please enter your feedback</span>

			<button type="button" class="btn mt-3 btn_rating_submit" name="btn_rating_submit" style="color: white;border-radius: 15px;border:1px solid #58547e;font-weight: bold;background-color: #01cfbe" onclick="rating_submit()" disabled="true">Submit</button>

			<button type="button" class="btn mt-3 btn_browse_more" name="btn_browse_more" style="color: white;border-radius: 15px;border:1px solid #58547e;font-weight: bold;background-color: #706898" onclick="browse_more()">Continue Browsing</button>
...
function show_feedback_placeholder(){
	...
	$('.feedback').attr('placeholder','Your Feedback (optional)');
