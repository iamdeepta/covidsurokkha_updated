...
#div3 {
  ...
  /*animation: marquee 10950s linear infinite;*/
  animation: marquee_three 38s linear infinite;
  /*animation: marquee 50s linear infinite;*/
}
...
#div4 {
  ...
  animation: marquee_four 38s linear infinite;
  animation-delay: 19s;
...
?>
	...
	<div class="" id="bulletin1" style="margin-top: 30px;padding: 0px 20px;background-color: #b3d0ca;">

		<div id="maindiv1" style="padding-top: 0px;margin-bottom: -32px">
...
One div will translate completely out of parent and other div will fill the void till the transition for first div starts again. -->
  <div id="div3">
    ...
    <span style="font-weight: bold;padding-left: 20px"><span style="color: #000000;font-family: sans-serif;font-size: 14px">If you need information related to Covid-19 sample test, treatment and hospital call - 01313791130, 01313791138, 01313791139, 01313791140, 01321173865 <!-- <a href="tel:16263" style="text-decoration: none;color: #000000">16263</a> --></span></span>
