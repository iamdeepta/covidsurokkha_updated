...
<?php }?>
<?php }else{?>
  <?php if($result['blogs_title_bn']!=''){?>
  <h1 class="notranslate" id="our_blogs_text" style="font-size: 36px;font-weight: bold;color: #fff"><?=$result['blogs_title_bn']?></h1>
<?php }else{?>
  <h1 id="our_blogs_text" style="font-size: 36px;font-weight: bold;color: #fff"><?=$result['blogs_title_en']?></h1>
<?php }?>
<?php }?>
...
<div id="blog_detail_section" style="margin-top: -10px">
  ...
  <div id="blog_detail_div" class="container" style="text-align: center;padding:0px 50px">
    ...
    <img id="blog_detail_image1" src="admin/files/blogs_images/<?php echo $result['blogs_image1'];?>" alt="<?php echo $result['blogs_image1_alt_bn']?>" style="border-radius: 20px;object-fit: cover;height: 506px;width: 870px" data-aos="zoom-in" data-aos-duration="1000">
    ...
    <?php }else{?>
      <div id="blogs_time_div" style="margin-top: 10px;font-size: 14px;text-align: left;padding: 0px 120px;margin-top: 20px" data-aos="zoom-in" data-aos-duration="1000"><i class="far fa-clock"></i><span class="notranslate" style="margin-left: 3px"><?=BanglaConverter::en2bn($result['blogs_time'])?> মিনিট পড়া</span></div>
    <?php }?>
    ...
    <?php }?>
    <?php }else{?>
      <?php if($result['blogs_description1_bn']!=''){?>
      <p class="notranslate"><?=$result['blogs_description1_bn']?></p>
    <?php }else{?>
      <p><?=$result['blogs_description1_en']?></p>
    <?php }?>
    <?php }?>
    ...
    <div id="blog_detail_image2_div" data-aos="fade-right" data-aos-duration="1000"><img id="blog_detail_image2" src="admin/files/blogs_images/<?php echo $result['blogs_image2'];?>" alt="<?php echo $result['blogs_image2_alt_bn']?>" style="border-radius: 15px;height: 242px;width: 425px;object-fit: contain;"></div>
    <?php }else{?>
    <?php }?>
    <?php if($result['blogs_image3']!=''){?>
    <div id="blog_detail_image3_div" style="margin-left: 30px" data-aos="fade-left" data-aos-duration="1000"><img id="blog_detail_image3" src="admin/files/blogs_images/<?php echo $result['blogs_image3'];?>" alt="<?php echo $result['blogs_image3_alt_bn']?>" style="border-radius: 15px;height: 242px;width: 425px;object-fit: contain;"></div>
    <?php }else{?>
    <?php }?>
  </div>
  ...
  <div id="blog_detail_second_paragraph" style="text-align: left;padding: 0px 120px;margin-top: 0px;white-space: pre-line;" data-aos="zoom-in" data-aos-duration="1000">
    ...
    <?php }?>
    <?php }else{?>
      <?php if($result['blogs_description2_bn']){?>
      <p class="notranslate"><?=$result['blogs_description2_bn']?></p>
    <?php }else{?>
      <p><?=$result['blogs_description2_en']?></p>
    <?php }?>
    <?php }?>
    ...
    <img id="blog_detail_image3_mbl" src="admin/files/blogs_images/<?php echo $result['blogs_image3'];?>" alt="<?php echo $result['blogs_image3_alt_bn']?>" style="border-radius: 15px;object-fit: cover;height: auto;width: 100%;margin-top: -10px;" data-aos="fade-left" data-aos-duration="1000">
...
<?php }else{?>
  ...
  <?php if($result4['blogs_id']!=@$_GET['id']){?> 
    ...
    <?php }else{?>
      <button class="btn" name="blogs_next" id="blogs_next_other" style="background-color: #a9c8c5;color: white;border-radius: 10px;width: 150px;pointer-events: none;cursor: no-drop;" data-aos="fade-left" data-aos-duration="1000" disabled="true"><span><i class="fas fa-long-arrow-alt-right" id="next_arrow1_other" style="transform: translateX(-50px);opacity: 0"></i></span> <span id="next_text_other" style="margin-right: 10px">পরে</span> <span><i class="fas fa-long-arrow-alt-right" id="next_arrow_other"></i></span></button>
    <?php }?>
  </div>
