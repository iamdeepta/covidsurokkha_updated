...
<li style="margin-top: 0px">
	<a class="notranslate" href="vaccine" title="Covid Symptom Checker" style="line-height: 22px"><span style="font-size: 15px;"><i class="fas fa-syringe" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>ভ্যাকসিন তথ্য</span></a>

</li>

<li style="margin-top: 0px">

	<a class="notranslate" href="symptom-checker" title="Covid Symptom Checker" style="line-height: 22px"><span style="font-size: 15px;"><img src="assets/images/symptom-checker-logo.png" alt="covidsurokkha" style="width: 20px;height: 18px;margin-left: -1px" />কোভিড লক্ষণ পরীক্ষক</span></a>
	
</li>

<li style="margin-top: 0px">
	
	<a class="notranslate" href="approved-laboratories" title="Approved Laboratories for International Travelling" style="line-height: 22px"><span style="font-size: 14px;"><i class="fas fa-info-circle" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>আন্তর্জাতিক ভ্রমণের জন্য কোভিড <span style="margin-left: 19px">ল্যাবরেটরিজ টেস্ট </span></span></a>
	
</li>

<li style="margin-top: 0px">
	<a class="notranslate" href="blogs" title="Covid Symptom Checker" style="line-height: 22px"><span style="font-size: 15px;"><i class="fas fa-blog" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>ব্লগ</span></a>

</li>

<li style="margin-top: 0px">
	<a class="notranslate" href="about-us" title="Covid Symptom Checker" style="line-height: 22px"><span style="font-size: 15px;"><i class="fas fa-briefcase" style="color: #58547e;font-size: 14px;margin-right: 5px"></i>আমাদের সম্পর্কে</span></a>
